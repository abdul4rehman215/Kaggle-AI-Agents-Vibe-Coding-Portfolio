...
### A documentation-first, implementation-backed portfolio built during the **Google/Kaggle 5-Day AI Agents Intensive Vibe Coding Course**
...
<p>
  ...
  <img src="https://img.shields.io/badge/Mode-Hands--On%20Codelabs%20%2B%20Documentation-0288D1?style=for-the-badge" />
</p>

<p>
  <img src="https://img.shields.io/badge/Focus-AI%20Agents-6A1B9A?style=for-the-badge" />
  <img src="https://img.shields.io/badge/Focus-Vibe%20Coding-8E24AA?style=for-the-badge" />
  <img src="https://img.shields.io/badge/Focus-Agentic%20Workflows-D32F2F?style=for-the-badge" />
  <img src="https://img.shields.io/badge/Focus-Security%20Automation-5E35B1?style=for-the-badge" />
  <img src="https://img.shields.io/badge/Focus-Cloud%20Deployment-FF6F00?style=for-the-badge" />
</p>

<p>
  <img src="https://img.shields.io/badge/Google%20Antigravity-Agent%20Development-4285F4?style=for-the-badge&logo=google&logoColor=white" />
  <img src="https://img.shields.io/badge/Google%20AI%20Studio-Vibe%20Coding-F9AB00?style=for-the-badge&logo=google&logoColor=black" />
  <img src="https://img.shields.io/badge/Cloud%20Run-Deployment-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" />
...
- Spec-Driven Development as a production workflow
- specs as the source of truth and code as regenerable implementation
- Behavior-Driven Development and Gherkin-style production thinking
...
```text
Study → Build / Review → Test / Validate → Capture Evidence → Document → Reflect → Improve
```
...
- a structured record of the Google/Kaggle AI Agents Intensive learning journey through Day 5
...
The remaining major portfolio section is the final capstone project.
...
2. Read the day-level README files from Day 1 through Day 5 in order.
...
```bash
git clone https://github.com/abdul4rehman215/Kaggle-AI-Agents-Vibe-Coding-Portfolio.git
```
...
- [Google Codelab — Deploy an ADK Agent to Agent Runtime using Agents CLI](https://codelabs.developers.google.com/enterprise-cloud-scale-deploying-the-expense-agent-to-agent-runtime-on-google-cloud)
- [Google Codelab — Vibecode and Deploy a Frontend for an ADK Agent](https://codelabs.developers.google.com/vibecode-frontend-with-antigravity)
