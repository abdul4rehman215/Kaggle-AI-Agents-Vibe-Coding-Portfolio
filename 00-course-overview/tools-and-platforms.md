...
Kaggle-related work will be documented through:
...
This course may involve API keys, cloud credentials, or environment-specific configuration. Those values must not be committed.
...
| Google Antigravity | Agent-first development workflow | `docs/`, Day 1 codelabs |
| Antigravity IDE | Visual agent development environment | `docs/`, screenshots |
| Antigravity CLI | Terminal interface for agent workflows | `docs/`, troubleshooting |
| Google AI Studio | Vibe coding and app generation | Day 1 codelabs |
| Cloud Run | Deployment platform | `docs/`, Day 1 codelabs |
